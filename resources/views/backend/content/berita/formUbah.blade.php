            ...
            <div class="card-body">
                <form action="{{route('berita.prosesUbah')}}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="judul_berita" value="{{$berita->judul_berita}}" class="form-control @error('judul_kategori')is-invalid @enderror">
                    ...
                    <div class="mb-3">
                        ...
                        @enderror
                        <p></p>
                        <img id="tampilFoto" onerror="this.onerro=null;this.src='https://t4.ftcdn.net/jpg/04/73/25/49/360_F_473254957_bxG9yf4ly7OBO5I0O5KABLN930GwaMQz.jpg';" src="{{route('storage',$berita->gambar_berita)}}" alt="" width="15%">
                    </div>
